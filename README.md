...
2. *application.R*: reproduces the SSTARLET phase III application (Section 5): a 4-stage design (n_l = c(100, 200, 300, 400)) with dynamic borrowing from historical control- and treatment-arm data. Historical data, design parameters, and both borrowing settings (tau = 0 and tau = "upper_bound", i.e. τ2=σ2/nℓ​) are set at the top of the script — simply source and run the file to reproduce all reported results and the ERR_curves.pdf figure (Figure 1).
